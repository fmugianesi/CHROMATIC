...
### 04. Transform the intra-chromosomal Hi-C maps into .npz scipy sparse arrays
...
### 05. Combine ChIP-seq and Hi-C data to identify the CHROMATIC interaction maps 
