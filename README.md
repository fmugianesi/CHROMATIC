...
This tutorial explains the code, while referring to the data relative to the application of CHROMATIC in NPCs, at the resolution of 5 kilobases, in reference mouse genome *mm10*.  
